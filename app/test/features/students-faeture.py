...
def step_impl(context):
    api_endpoints['POST_URL'] = api_url+'/students'
...
def step_impl(context):
    request_bodies['POST']={"id":223445,"firstName": "Abraham Ogol", "lastName": "Wong","clas":"3A","nationality": "Singapore"} 
...
def step_impl(context,id):
    api_endpoints['GET_URL'] = api_url+'/students'
...
def step_impl(context,id):
    api_endpoints['PUT_URL'] = api_url + '/students/'+id
    print('url :' + api_endpoints['PUT_URL'])

@when(u'I Set Update request Body')
def step_impl(context):
    request_bodies['PUT']={"clas": "3B"}

@when(u'Send PUT HTTP request')
def step_impl(context):
    # sending get request and saving response as response object  # response = requests.post(url=api_endpoints['POST_URL'], headers=request_headers) 
...
def step_impl(context,id):
    api_endpoints['DELETE_URL'] = api_url + '/students/'+id
